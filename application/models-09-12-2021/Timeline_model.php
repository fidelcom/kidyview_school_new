...
class Timeline_model extends CI_Model {
    ...
    public function insertComment($commentData = array()) {
        $this->db->insert('timeline_comment', $commentData);
        return true;
    }
    ...
    public function getAttachmentDetail($timeline_id = '', $attachId = '', $schoolId = '', $userid = '', $userType = '') {
        ...
        $this->db->select('t1.*,t2.description');
        $this->db->from('timeline_attachment t1');
        $this->db->join('timeline t2', 't1.timeline_id=t2.id', 'LEFT');
        if($attachId > 0)
        {
    ...
    public function getAttachmentComments($timeline_id = '', $attachId = '') {
        ...
        $this->db->from('timeline_comment al');
