...
//	prd($subjectTermData);	
   ...
   public function calculateSubjectTermResult($student_id,$school_id)
    ...
    {
		$this->db->delete('result_term_subject_data', array('student_id' => $student_id));
		$this->db->delete('result', array('student_id' => $student_id));
    	$this->db->delete('result_term_data', array('student_id' => $student_id));
