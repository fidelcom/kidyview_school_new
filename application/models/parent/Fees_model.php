...
class Fees_model extends CI_Model {
    ...
    {
        $where = array('currency_code'=>$currency_code);
       return $this->db->where($where)->get('admin_currency')->row_array();
    }
    public function paymentHistory()
    {
        ...
        foreach ($result as  $value) {
            ...
            $currency_symbol=$this->get_currency_symbol($value['currency']);
            $finalData[$i]['currecny_symbool']=$currency_symbol['currency_symbol'];
            $i++;
            // prd($finalData);
        }
