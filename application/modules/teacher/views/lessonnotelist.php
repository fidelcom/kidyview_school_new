        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="right-actions"><a href="#!/lesson-note" class="btn btn-primary"> <i class="icon-plus2"></i> Add Note</a></div>
                </div>
            </div>
        </div>
    </header>
									...
									<tr ng-repeat="lessonnote in lessonnotelist">
										...
										<td>{{lessonnote.subjectname}}</td>
							                        <td>{{lessonnote.activity_type}}</td>
                                                                                ...
                                                                                <td ng-if="lessonnote.status == '1' ">Approved</td>
                                                                                <td ng-if="lessonnote.status == '0' ">Not Approved</td>
                                                                                <td>{{lessonnote.created_date}}</td>
                                                                                <td class="text-right action">

                                                                                <a  href="#!/view-note/{{lessonnote.lessonID}}"><i class="icon-eye" title="View"></i></a>
                                                                                <a  href="#!/lesson-note-edit/{{lessonnote.lessonID}}"><i class="icon-edit" title="View"></i></a>
                                                                                </td>
									</tr>
								</tbody>
							</table>	
