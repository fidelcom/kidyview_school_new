        ...
        <div class="row">
            ...
            <div class="col-md-12 answer-col mt-2">
                <div class="row"> 
                    ...
                    <div class="col-md-2 col-sm-6" ng-repeat="opt in ques.option_value" ng-if="opt.isUserAnswer!='false'">
					...
					<div class="col-md-12 answer-col" ng-show="ques.question_type=='textual'" ng-repeat="opt in ques.option_value">{{opt.isUserAnswer}}</div>
