...
<div class="app-main">
	...
	<header class="main-heading">
		<div class="container-fluid">
			...
			<a href="#!/create-project" class="btn btn-primary"> <i class="icon-plus2"></i> New Project</a>
			</div>
			</div>
			</div>
		</div>
	...
	<div class="main-content">
		<div class="card">
				...
				<div class="col-md-4">
					<select class="form-control" ng-model="class_id" ng-change="getProjectList()"> 
						<option value="">Select Class</option>
						<option value="{{class.id}}" ng-repeat="class in classArray | unique : 'id'">{{class.name}}</option>
					</select>
				</div>
				<div class="col-md-4">
					<select class="form-control" ng-model="subject_id" ng-change="getProjectList()"> 
						<option value="">Select Subject</option>
						<option value="{{subject.id}}" ng-repeat="subject in subjectArray | unique : 'id'">{{subject.name}}</option>
					</select>
				</div>
				<div class="col-md-4">
					<select class="form-control" ng-model="category" ng-change="getProjectList()"> 
				...
				<thead>
						<tr>
							<th>S.No.</th>
							<th class="sorting-tb">Project Name</span></th>
							<th class="sorting-tb">Subject</th>
							<th class="sorting-tb">Class</th>
							<th class="sorting-tb">No. of attempt</th>
							<th>Open Project Date</th>
							<th>Issued Date</th>
							<th>Due Date</th>
							<th class="text-right td-no-wrap">Action</th>
						</tr>
					</thead>
					<tbody>
						<tr ng-repeat="assignment in assignmentData">
							...
							<td class="action text-right td-no-wrap">
							<a href="#!/project-detail/{{assignment.assignmentID}}"><i class="icon-eye" title="View"></i></a>
							<a href="#!/edit-project/{{assignment.assignmentID}}" data-toggle="tooltip" data-original-title="View Detail" data-placement="top"><i class="icon-edit2"></i></a>
							<a href="javascript:void(0);" ng-click="deleteProject(assignment.id)"><i class="icon-trash"></i></a>
							</td>
						</tr>															
					</tbody>
				</table>
