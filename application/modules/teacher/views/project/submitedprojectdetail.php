...
<div class="page-icon">
<a href="#!/submitted-project-list"> <i class="icon-arrow-back"></i></a>
</div>
<div class="page-title">
<h5> Submitted Project Details</h5>
</div>
</div>
...
<div class="row">
	...
	<div class="row">
		<div class="col-md-3 col-lg-3 col-sm-12">Assign Marks</div>
		<div class="col-md-9 col-lg-9 col-sm-12 text-highligh">
		<input type="text" numericonly ng-model="assignmentinfo.getAssignMarkData.marks_obtained"/><i class="fa fa-plus-circle" aria-hidden="true" ng-click="assignMarks(assignmentinfo);"></i>
		</div>
	</div>
	<div class="row" ng-if="assignmentinfo.getAssignMarkData.grade!=null && category=='graded'" >
	...
	<div class="row">
		...
		<button class="btn btn-primary mt-2" type="button" ng-click="updateProjectFeedback(id,feedback);">{{feedbackButton}}</button>
		</div>
...
<div class="row" ng-if="attachmentArray.length>0">
		...
		<div class="col-md-9 col-lg-9 col-sm-12 text-highligh">
			<div class="btn-group send_btn DownloadAll mb-2">
				<a href="javascript:void(0);" ng-click="submitprojectdownload(assignmentinfo.id,assignmentinfo.user_id);" class="btn btn-info btn-sm"><i class="icon-download3"></i> Download All</a>
			</div>			
		</div>
	</div>
	<div class="row">
	...
	<div class="form-group">
		<a class="btn btn-secondary" href="#!/submitted-project-list">Back To List</a>
	</div>
	</div>
