    ...
    <div class="card-body">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-xl- col-lg-7 col-md-7 col-sm-7 align-self-center">
                        <div class="media">
                            ...
                            <img ng-show="conversationData.user_detail.user_type=='Teacher'" src="<?php echo base_url();?>img/teacher/{{conversationData.user_detail.photo}}" alt="{{converation.user_detail.fname}}" />
                                    <img ng-show="conversationData.user_detail.user_type=='Student'" src="<?php echo base_url();?>img/child/{{conversationData.user_detail.photo}}" alt="{{converation.user_detail.fname}}" />    
                            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="frame">
                    <div class="content">
                        <div class="messages" schroll-bottom="conversationData">
                        ...
                        <div class="message-input">
							...
							<ul>
                                ...
                                <div ng-show="prev.prev=='pdf' || prev.filetype=='doc' || prev.filetype=='docx'">
                                    <span class="close-upload-p-btn"><i ng-click="remove($index);" class="fa fa-trash" aria-hidden="true"></i></span>
									<i class="far fa-file"></i>
                                </div>
                                <div ng-show="prev.filetype=='mp4' || prev.filetype=='3gp' || prev.filetype=='avi' || prev.filetype=='flv'  || prev.filetype=='wmv'">
                                	<span class="close-upload-p-btn"><i ng-click="remove($index);" class="fa fa-trash" aria-hidden="true"></i></span>
