		...
		<div class="card-body class-cardbody" ng-repeat="post in classboardPostData track by $index">
			...
			<div class="rply-classboard-comment pl-5">
				...
				<div class="media media-class-board" ng-repeat="comment in post.commentData | orderBy : 'post.created'">
					<a href="javascript:void(0);" class="float-left" ng-show="comment.user_type=='Student'"> <img alt="" src="<?php echo base_url();?>img/child/{{comment.photo}}" class="img-circle" width="40">
					</a>
					<a href="javascript:void(0);" class="float-left" ng-show="comment.user_type=='Teacher'"> <img alt="" src="<?php echo base_url();?>img/teacher/{{comment.photo}}" class="img-circle" width="40">
					</a>
					<div class="media-body">
