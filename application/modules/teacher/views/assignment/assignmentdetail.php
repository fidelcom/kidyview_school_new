...
<div class="card-body vendor-full-detail">
	...
	<div class="row">
		<div class="col-md-3 col-lg-3 col-sm-12">Open Assignment Date:</div>
	...
	<div class="row" ng-if="attachmentArray.length>0">
		...
		<div class="col-md-9 col-lg-9 col-sm-12 text-highligh">
			<div class="btn-group send_btn DownloadAll">
				<a href="javascript:void(0);" ng-click="assignmentdownload(assignmentinfo.id);" class="btn btn-info btn-sm"><i class="icon-download3"></i> Download All</a>
			</div>			
		</div>
	</div>
	<div class="row">
