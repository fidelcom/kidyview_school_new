									...
									<tr ng-repeat="lessonnote in lessonnotelist">
										...
										<td>{{lessonnote.subjectname}}</td>
							                        ...
							                        <td>{{lessonnote.created_date}}</td>
                                                                                ...
                                                                                <span>
                                                                                <a  href="#!/view-shared-note/{{lessonnote.lessonID}}"><i class="icon-eye" title="View"></i></a>        
                                                                                </span>     
                                                                                <span ng-if="lessonnote.edit_right == '2' ">
                                                                                <a  href="#!/shared-lesson-edit/{{lessonnote.lessonID}}"><i class="icon-edit" title="Edit"></i></a>        
                                                                                </span>
