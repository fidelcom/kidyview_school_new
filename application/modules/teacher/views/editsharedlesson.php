				...
				<form>
							...
							<div class="form-group ">
					                <label class="form-label">Subject</label>
                                                        <select class="form-control select-new" disabled ng-model="lessonsubject">
							...
							<div class="form-group ">
					                <label class="form-label">Topic<em>*</em></label>
                                                        <input type="text" class="form-control" ng-model="topic" disabled  placeholder="Enter Topic">
							</div>
					                ...
					                <label class="form-label">Share With</label>
                                                        ...
                                                        <span class="sharespan"><input type="radio"  name="teacher_share" ng-model="teacher_share" ng-checked="teacher_share == '1'" value="1"> Share Teacher With View Only</span>
                                                        <span class="sharespan"><input type="radio" name="teacher_share" ng-model="teacher_share" ng-checked="teacher_share == '2'" value="2"> Share Teacher With Edit & View</span>
                                                        <span class="sharespan"><input type="radio" name="teacher_share" ng-model="teacher_share" ng-checked="teacher_share == '0'" value="0"> No Share With Teachers</span>
							...
							<div class="form-group multi-dorpdown-list">
					                <label class="form-label">Class<em>*</em></label>
                                                        <select class="form-control" multiple="multiple"  ng-model="lessonclass">
                                                                <option ng-selected="{{lessonclass.indexOf(classes.id.toString())!=-1}}"  ng-repeat="classes in allclass" value="{{classes.id}}">{{classes.class}} - {{classes.section}}</option>
                                                        </select>
							</div>
							...
							<div class="form-group multi-dorpdown-list">
					                <label class="form-label">Teacher<em>*</em></label>
                                                        <select class="form-control" multiple="multiple"  ng-model="teacherlist">
                                                                <option ng-selected="{{teacherlist.indexOf(teacher.id.toString())!=-1}}"  ng-repeat="teacher in allteacher" value="{{teacher.id}}">{{teacher.teacher}}</option>
                                                        </select>
							</div>
							...
							<div class="upload-preview-box"><a target="_blank" href="<?php echo base_url();?>img/teacher/lessonnote/{{prev.attachment}}">{{prev.attachment}}</a></div>
                                                ...
                                                <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <button class="btn btn-primary"  ng-click="updateNote()">Update Note</button>
                                                </div>
                                               </div>    
...
.multi-dorpdown-list select.form-control option[ng-selected="true"] {
    background: #b7b7b7;
    color: #000;
}
</style>