                        ...
                        <table class="table table-striped table-bordered table-responsive text-left">
                            ...
                            <tfoot class="bg-dark text-white">
                                ...
                                <tr ng-repeat="termTotal in totalTermResult" ng-if="(termTotal.term_id == term.term_id)">
                                    ...
                                    <th class="text-center" colspan="4" style="color: blue;background: white;">	{{(termTotal.is_approved) ? termTotal.is_approved : '-'}}</th>
                                </tr>
                        ...
                        <!--<form class="mt-3" action=" ">
                            <div class="row">
                                <div class="col-md-12 text-left">
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn btn-primary" ng-click="approveDisapproveResult(term.term_id,grandTotalMarks.student_id,resultStatus,reason)">Save</button>
                                    </div>
                                </div>
