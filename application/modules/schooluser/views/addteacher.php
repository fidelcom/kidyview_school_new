			...
			<div class="add-teacher">
				<form name="myForm">
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<div class="controls">
								<input type="password" name="password" class="form-control" id="password" ng-model="password" placeholder="Password" ng-minlength="6"> 
								...
								<div class="controls">
								<input type="password"  name="confirmpassword" class="form-control" id="confirmpassword" ng-model="confirmpassword" placeholder="Confirm Password" compare-to="password">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="form-group">
										<label class="form-label">Spouse Name/Father Name</label>
										<div class="controls">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="form-group">
										<label class="form-label">Contact Number of Spouse/Father</label>
										<div class="controls">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="form-group select_mutli add_subject">
										...
										<div class="controls">
											<select class="form-control" multiple="multiple" ng-model="assignclassteacher">
								...
								<div class="col-md-6 col-sm-6 col-xs-12 mt-2">
									<div class="form-group">
										...
										<div class="upload-preview-box upload-img-view" ng-show="isImage(fileExt)">
											<img  ngf-src="teacherphoto[0]" class="thumb">
										</div>
										</div>
										<div class="btn-uploadprof uploadcertificate" style="width:300px;">
											<span>
												<i class="icon-camera-outline"></i>
												<input class="file-upload" ngf-select="" ngf-change="onChange($files)" id="teacherphoto" ng-model="teacherphoto" accept="image/png, image/jpeg" type="file" />
												<span>Browse</span>
											</span>
										</div>
									</div>
									...
									<div class="row education-row" ng-repeat="educationalfield in educationalfields track by $index">
										...
										<div class="col-md-2 col-sm-2 col-xs-12">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" name="yearofpassing" class="form-control digit-only" ng-model="educationalfields[$index].year_of_passing" />
												</div>
											</div>
										</div>
										<div class="col-md-2 col-sm-2 col-xs-12">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" name="percentage" class="form-control digit-only" ng-model="educationalfields[$index].percentage" />
												</div>
											</div>
										</div>
										<div class="col-md-2 col-sm-2 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="btn-uploadprof education-proff uploadcertificate">
													<span>
														...
														<input class="file-upload" name="qualificationCertificate"type="file" id="educationcertificate" onchange="angular.element(this).scope().uploadEducationCertificate('educationcertificate',angular.element(this).scope().$index)"/>
														<span>Browse</span>
													</span>
												</div>
											</div>
										...
										<div class="row exp-row" ng-repeat="experiancefield in experiancefields track by $index">
											...
											<div class="col-md-1 col-sm-1 col-xs-12">
												<div class="form-group">
													...
													<div class="controls">
														<input type="text" class="form-control digit-only" ng-model="experiancefields[$index].numofyears">
													</div>
												</div>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
											...
											<div class="col-md-2 col-sm-2 col-xs-12">
												<div class="form-group">
													...
													<div class="controls">
														<input type="date" onkeydown="return false" class="form-control" ng-model="experiancefields[$index].datefrom" max="<?=date('Y-m-d')?>">
													</div>
												</div>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-12">
												<div class="form-group">
													...
													<div class="controls">
														<input type="date" onkeydown="return false" class="form-control" ng-model="experiancefields[$index].dateto" max="<?=date('Y-m-d')?>">
													</div>
												</div>
											</div>
												...
												<div class="form-group exp-wrapper d-inline-flex  ">
													...
													<div class="btn-uploadprof education-proff uploadcertificate d-inline-flex  ">
														<span>
															...
															<input class="file-upload" name="experiencecertificate"type="file" id="experiencecertificate" onchange="angular.element(this).scope().uploadExperienceCertificate('experiencecertificate',angular.element(this).scope().$index)"/>
															<span>Browse</span>
														</span>
													</div>
												</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
						<div class="form-group">
							<button class="btn btn-primary" ng-disabled="myForm.$invalid" ng-click="addTeacher()">Submit</button>
