...
<div class="row">
	...
	<div class="row">
		<div class="col-md-3 col-lg-3 col-sm-12">Assignment Cateory:</div>
	...
	<div class="row">
		...
		<input class="assignMarks" type="text" ng-model="assignmentinfo.getAssignMarkData.marks_obtained"/><span class="plusbutton"><i class="fa fa-plus-circle" aria-hidden="true" ng-click="assignMarks(assignmentinfo);"></i></span>
		</div>
	</div>
...
<div class="row" ng-if="attachmentArray.length>0">
		...
		<div class="col-md-9 col-lg-9 col-sm-12 text-highligh">
			<div class="btn-group send_btn DownloadAll mb-2">
				<a href="javascript:void(0);" ng-click="submitassignmentdownload(assignmentinfo.id,assignmentinfo.user_id);" class="btn btn-info btn-sm"><i class="icon-download3"></i> Download All</a>
			</div>			
		</div>
	</div>
	<div class="row">
