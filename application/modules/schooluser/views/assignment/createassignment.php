		...
		<div class="error" ng-show="errormsg">{{errormsg}}</div>
			...
			<div class="row form-group">
					<div class="col-md-4 col-lg-3 pr-3 pr-md-0">
						<label>Select Class<em class="text-danger">*</em></label>
					</div>
					<div class="col-md-6 pl-0">
						<div class="form-group multi-dorpdown-list">
							<div class="controls">
								<select class="form-control" ng-model="class_id"ng-change="getSchoolSubject()" >
				...
				<div class="col-md-3 pr-0">
					<label>Select Subject<em class="text-danger">*</em></label>
				</div>
				<div class="col-md-6 pl-0">
					<div class="form-group multi-dorpdown-list">
						<div class="controls">
				...
				<div class="row form-group">
				<div class="col-md-3 pr-0">
					<label>Select Category<em class="text-danger">*</em></label>
				</div>
				<div class="col-md-6 pl-0">
					<div class="form-group multi-dorpdown-list">
						<div class="controls">
				...
				<div class="row form-group">
					<div class="col-md-3 pr-0">
						<label>Assignment Name<em class="text-danger">*</em></label>
					</div>
					<div class="col-md-6 pl-0">
				...
				<div class="row form-group">
					<div class="col-md-3 pr-0">
						<label>Total Marks<em class="text-danger">*</em></label>
					</div>
					<div class="col-md-6 pl-0">
						<input type="text" class="form-control" ng-model="total_marks" name="totalmarks" value='' />
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-3 pr-0">
				...
				<div class="row form-group">
					<div class="col-md-3 pr-0">
						<label>Submission Date<em class="text-danger">*</em></label>
					</div>
					<div class="col-md-6 pl-0">
				...
				<div class="row form-group">
					...
					<div class="row form-group">
						<div class="col-md-3 pr-0">
							<label>Description<em class="text-danger">*</em></label>
						</div>
						<div class="col-md-6 pl-0">
