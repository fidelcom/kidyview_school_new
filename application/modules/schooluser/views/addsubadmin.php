		...
		<form name="myForm">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="form-group">
					...
					</select> <a class="btn btn-primary mt-2 mb-3" href="#!/add-role">Add New Role</a>
					</div>
				</div>
			</div>
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" class="form-control" id="sub-admin-name" ng-model="name" placeholder="Full Name">
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<div class="controls">
							<input type="email" class="form-control" name="email" id="email" ng-model="email" placeholder="Email Address">
				...
				<div class="form-group">
					<button class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid" ng-click="addSubadmin()" name="submit">Add Sub Admin</button>
					<a class="btn btn-secondary btn-sm" href="#!/subadmin-list">Back To List</a>
				</div>
				</div>
			</div>
		</form>
