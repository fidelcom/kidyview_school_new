            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 align-self-center">
                    ...
                    <div class="page-title">
                        <h5>Vehicle  Management (Edit Vehicle)</h5>
                    </div>
                </div>
                ...
                <form action="">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                      <select ng-model="routes" class="form-control" id="routes" >
                                        ...
                                        <option ng-selected="{{route.id == routes}}" ng-repeat="route in routeList" value="{{route.id}}">{{route.name}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profileimg">
                                <img class="img-fluid img-circle" src="<?=base_url()?>img/driver/{{photo}}" alt="Vehicle Photo" />
                        </div>
			</div>
                        
                        <div class="col-md-12 col-sm-12 col-xs-12 mt-3">
                            <div class="form-group">
                                <input class="btn btn-primary" type="button" name="submit" value="Update Vehicle" ng-click="updateVehicle()">
                            </div>
                        </div>
                    </div>
                </form>
