					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<textarea class="form-control" rows="2" ng-model="eventaddress"></textarea>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div>
								<div class="certificates">
									<a class="group" rel="gallery1" title="{{title}}"><img src="<?=base_url() ?>img/event/{{eventphoto}}" /></a>
								</div>
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<div class="btn-uploadprof uploadlogo upload-photo-event">
									<span>
										...
										<input class="file-upload ng-pristine ng-valid ng-not-empty ng-touched" id="pic" ng-model="eventphoto" type="file">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 mt-0 mt-md-2">
							<div class="form-group">
								<button class="btn btn-primary" ng-click="editEvent(eventId)" name="submit">Update</button>
