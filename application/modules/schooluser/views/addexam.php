                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 align-self-center">
                                ...
                                <div class="page-title">
                                    <h5>Create Online Assessment</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                           ...
                                           <!--  <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Exam Code<em>*</em></label>
                                                    <div class="controls">
                                                        <input type="text" class="form-control" required="required" ng-model="exam_code" placeholder="Exam Code">
                                                    </div>
                                                </div>
                                            </div> -->
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">No. of Attempts<em>*</em></label>
                                                    <div class="controls">
                                           ...
                                           <div class="col-md-12 col-sm-12 col-xs-12 mt-0">
												<button ng-click="addExam()" class="btn btn-primary">Submit</button>
