			...
			<div class="card-body">
				<form>
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="controls">
									<select class="form-control" ng-model="academicsession">
										<option ng-show="session.current_sesion==1" ng-repeat="session in sessionList" value="{{session.academicsession}}">{{session.academicsession}}</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<button class="btn btn-primary" ng-click="addClass()">Submit</button>
