...
<div class="app-main">
	...
	<div class="main-content">
				<div class="card">
					<div class="card-body">
						<form action="class-schedule.html" method="post">
								...
								<div class="col-md-7 pl-0">
									<div class="lecture_time_list" ng-repeat="time in scheduletime">
										...
										<div class="lec_list">
											...
											<!-- <input class="form-control" type="time" ng-model="time.start_time" ng-value="{{time.start_time}}"> -->
											<input class="form-control" type="time" ng-model="startTime" ng-value=""/>
											<span>End Time</span>
											<input class="form-control" type="time" ng-model="endTime"/>
										</div>
									</div>
								</div>
							</div>
