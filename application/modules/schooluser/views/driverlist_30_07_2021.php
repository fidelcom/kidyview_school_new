			...
			<div class="row">
				...
				<div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
					<div class="right-actions"><a href="#!/add-driver" class="btn btn-primary"> <i class="icon-plus2"></i> Add Driver</a></div>
                                        <div class="right-actions"><a href="#!/add-vehicle" class="btn btn-primary"> <i class="icon-plus2"></i> Add Vehcle</a></div>
                                        <div class="right-actions"><a href="#!/add-route" class="btn btn-primary"> <i class="icon-plus2"></i> Add Route</a></div>
                                        <div class="right-actions"><a href="#!/assign-student" class="btn btn-primary"> <i class="icon-plus2"></i> Assign Student</a></div>
				</div>
			</div>
		</div>
	</header>
			...
			<div class="card-body">
				 ...
				 <table datatable="ng" class="table school-listing-c table-striped table-bordered table-responsive white-space-nowrap">
					...
					<tbody>  <tr ng-repeat="driver in driverList">
							...
							<td>{{$index + 1}}</td>
							<td>{{driver.driverfname}} {{driver.driverlname}} ({{driver.drivercode}})</td>
