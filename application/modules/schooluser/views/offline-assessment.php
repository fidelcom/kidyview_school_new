				...
				<div class="row">
					<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 align-self-center">
						...
						<div class="page-title">
							<h5>Offline Assessment</h5>
						</div>
					</div>
					<div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
						<div class="right-actions">
							<a href="#!/add-offline-assessment" class="btn btn-primary"> <i class="icon-plus2"></i> Create</a>
						</div>
					</div>
				</div>
			</div>
							...
							<table datatable="ng" class="table table-striped table-bordered table-responsive custom-scrollbar">
								...
								<tr ng-repeat="exam in examList">
										...
										<td class="action text-right">
											...
											<a href="#!/edit-offline-assessment/{{exam.id}}" data-toggle="tooltip" data-original-title="Edit" data-placement="top" ng-if="exam.exam_date_time > exam.current_datetime"><i class="icon-edit2"></i></a>
											
											<a href="#!/offline-assessment-student/{{exam.id}}" data-toggle="tooltip" data-original-title="View" data-placement="top"><i class="icon-eye"></i></a>
