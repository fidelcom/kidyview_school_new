...
<nav class="side-nav">
    <ul class="unifyMenu customScroll" id="unifyMenu">
        ...
        <?php 
		if((isset($ALLPRIVILEGE['Parents']) && $ALLPRIVILEGE['Parents']['module']==1) OR (isset($ALLPRIVILEGE['Teacher']) && $ALLPRIVILEGE['Teacher']['module']==1) OR (isset($ALLPRIVILEGE['Driver']) && $ALLPRIVILEGE['Driver']['module']==1) OR (isset($ALLPRIVILEGE['SubAdmin']) && $ALLPRIVILEGE['SubAdmin']['module']==1) OR (isset($ALLPRIVILEGE['Students']) && $ALLPRIVILEGE['Students']['module']==1)){ ?>
        <li class="">
            ...
            <?php }if(isset($ALLPRIVILEGE['Driver']['module']) && $ALLPRIVILEGE['Driver']['module']==1){?>
                <li><a class="active has-arrow" href="javascript:void();">Driver</a>
                    <ul class="collapse">
                        ...
                        <li><a href="#!/assign-student">Assign Student</a></li>
                    </ul>
                </li>
        ...
        if((isset($ALLPRIVILEGE['ClassSchedule']) && $ALLPRIVILEGE['ClassSchedule']['module']==1) OR (isset($ALLPRIVILEGE['TimeTable']) && $ALLPRIVILEGE['TimeTable']['module']==1)){?>
		 <li class="">
            <a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
                <span class="has-icon">
        ...
        <ul aria-expanded="false" class="collapse" style="">
        <?php if(isset($ALLPRIVILEGE['Events']['module']) && $ALLPRIVILEGE['Events']['module']==1){?> 
        ...
        <?php }
        if((isset($ALLPRIVILEGE['StudentAttendance']) && $ALLPRIVILEGE['StudentAttendance']['module']==1) OR (isset($ALLPRIVILEGE['TeacherAttendance']) && $ALLPRIVILEGE['TeacherAttendance']['module']==1) OR (isset($ALLPRIVILEGE['SubadminAttendance']) && $ALLPRIVILEGE['SubadminAttendance']['module']==1) OR (isset($ALLPRIVILEGE['RequestDayOff']) && $ALLPRIVILEGE['RequestDayOff']['module']==1)){?>
        <li class="">
        <a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
            <span class="has-icon">
        ...
        <?php }
        if((isset($ALLPRIVILEGE['Session']) && $ALLPRIVILEGE['Session']['module']==1) OR (isset($ALLPRIVILEGE['Term']) && $ALLPRIVILEGE['Term']['module']==1) OR (isset($ALLPRIVILEGE['Class']) && $ALLPRIVILEGE['Class']['module']==1) OR (isset($ALLPRIVILEGE['Subject']) && $ALLPRIVILEGE['Subject']['module']==1) OR (isset($ALLPRIVILEGE['Assign']) && $ALLPRIVILEGE['Assign']['module']==1) OR (isset($ALLPRIVILEGE['TransferStudents']) && $ALLPRIVILEGE['TransferStudents']['module']==1) OR (isset($ALLPRIVILEGE['Fees']) && $ALLPRIVILEGE['Fees']['module']==1) OR (isset($ALLPRIVILEGE['TrackCab']) && $ALLPRIVILEGE['TrackCab']['module']==1) OR (isset($ALLPRIVILEGE['Result']) && $ALLPRIVILEGE['Result']['module']==1)){?>
        <li class="">
        <a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
            <span class="has-icon">
        ...
        <ul aria-expanded="false" class="collapse" style="">
            ...
            <li><a href="#!/transfer-student">Transfer Students</a></li>
        ...
        <?php } 
        if((isset($ALLPRIVILEGE['Fees']) && $ALLPRIVILEGE['Fees']['module']==1)){ ?>
         <li class="">
        ...
        <?php } 
        if((isset($ALLPRIVILEGE['DiscussionCategory']) && $ALLPRIVILEGE['DiscussionCategory']['module']==1) OR (isset($ALLPRIVILEGE['Discussion']) && $ALLPRIVILEGE['Discussion']['module']==1)){ 
        ?>
        <li class="">
        <a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
            <span class="has-icon">
        ...
        if(isset($ALLPRIVILEGE['Timeline']) && $ALLPRIVILEGE['Timeline']['module']==1){?>
        <li>
    ...
    <li>
	<a href="#!/lesson-note" aria-expanded="false">
	<span class="has-icon"><i class="icon-drag_handle"></i></span>
	<span class="nav-title">Lesson & notes</span>
        ...
        <ul aria-expanded="false" class="collapse" style="">
            ...
            <li><a href="#!/activityperformance-list">Activity Performance</a></li>
