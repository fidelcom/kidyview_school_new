                                    ...
                                    <div class="card-body">
                                        ...
                                        value= {{(question_marks_total)}}>
                                         ...
                                         <input type="hidden" ng-model="question_qty" value={{question_qty}}>
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12" id="answerDiv">
                                                <div class="form-group">
                                                    <label class="form-label">Add Answer<em>*</em></label>
                                                    <div class="controls">
                                                        <input type="text" ng-model="add_answer" class="form-control" placeholder="Enter answer (For multiple answers, Write answers with comma separated. e.g:ans,ans1,ans2 )" required="required">
                                                    </div>
                                                </div>
                                            </div>
											...
											<div class="col-md-12 col-sm-12 col-xs-12 mt-2">
												<button type="button" ng-click="createSchedule()" class="btn btn-primary">Submit</button>
