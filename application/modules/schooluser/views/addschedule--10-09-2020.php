								...
								<div class="col-md-7 pl-0">
									<div class="lecture_time_list" ng-repeat="x in scheduleTime" >
										...
										<div class="lec_list">
											...
											<input class="form-control" ng-model="x.start_time" type="time" name="start_time">
											<span>{{x.end_level}}</span>
											<input class="form-control" ng-model="x.end_time" type="time" name="end_time">
										</div>
