				...
				<form name="myForm">
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<div ng-show="isImage(fileExt)" class="upload-preview-box">
									<img ngf-src="pic[0]" class="thumb">
								</div>
								<div class="btn-uploadprof uploadlogo mt-0">
									<span>
										<i class="icon-camera-outline"></i>
										<input class="file-upload" ngf-select="" ngf-change="onChange($files)" id="pic" ng-model="pic" accept="image/png, image/jpeg" type="file" />
						...
						<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
							<div class="form-group">
								<button class="btn btn-primary" ng-click="addArticle()" name="submit">Submit</button>
