			...
			<div class="card-body">
				<form name="myForm">
					<div class="divide-box row">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" class="form-control" ng-model="fpincode" pattern="^[0-9]+$" ng-pattern-restrict id="fatheraddresspostal_code" disabled="true"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								<div class="profileimg">
									<img class="img-fluid img-circle" src="<?=base_url() ?>img/parent/{{fatherphoto}}" alt="User profile" />
								</div>
					...
					<div class="divide-box row">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="form-label">Postal Code</label>
								<div class="controls">
									<input type="text" class="form-control" ng-model="mpincode" pattern="^[0-9]+$" ng-pattern-restrict id="motheraddresspostal_code" disabled="true"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								<div class="profileimg">
									<img class="img-fluid img-circle" src="<?=base_url() ?>img/parent/{{motherphoto}}" alt="User profile" />
								</div>
								<div class="btn-uploadprof uploadlogo">
									<span>
										<i class="icon-camera-outline"></i>
					...
					<div class="divide-box row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="form-label">Emergency Contact Name<em>*</em></label>
								<div class="row">
									<div class="controls col-md-6 col-sm-6">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="form-label">Postal Code</label>
								<div class="controls">
									<input type="text" class="form-control" ng-model="epincode" pattern="^[0-9]+$" ng-pattern-restrict id="emergencyaddresspostal_code" disabled="true"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<div class="profileimg">
									<img class="img-fluid img-circle" src="<?=base_url() ?>img/parent/{{emergencyphoto}}" alt="User profile" />
								</div>
								<div class="btn-uploadprof uploadlogo">
									<span>
										<i class="icon-camera-outline"></i>
							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
											<input type="date" onkeydown="return false" ng-model="childdob" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="btn-uploadprof" style="width:300px;">
											<span>
												<i class="icon-camera-outline"></i>
												<input class="file-upload ng-pristine ng-valid ng-not-empty ng-touched" id="certificate" ng-model="childcertificate" type="file">
												<span>Upload Certificate</span>
											</span>
										</div>
									</div>
									<div class="form-group float-right">
										<button class="btn btn-primary" ng-click="addChild()">Save Child</button>
									</div>
								</div>
							</div>
						</form>
