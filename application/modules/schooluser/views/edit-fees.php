							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
											<select class="form-control" ng-model="fees.school_type">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" ng-model="feesDetails.fee_amount" class="form-control digit-only">
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- 
											...
											<select class="form-control category_ids" id="catList" ng-model="fees.category_ids"   ng-init="fees.category_ids = array[fees.category_ids]" multiple="multiple" >
												<option  ng-selected="{{category_ids.indexOf(cat.id.toString())!=-1}}"    ng-repeat="cat in feesCategory" value="{{ cat.id }}">{{ cat.category }}</option>
											</select>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
											<select class="form-control" ng-model="feesDetails.fee_type">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
											<textarea class="form-control" ng-model="feesDetails.description"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-6 mt-3 mb-1">
									<div class="form-check">
										<label class="form-check-label">Include Subscription
											<span ng-show="subAmount" class="text-center label label-danger" id="subscriptionAmount">{{subscriptionAmount.amount ? subscriptionAmount.amount : '0'  }}</span>
								...
								<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
									<div class="form-group">
										<input class="btn btn-primary" type="button" ng-click="UpdateFees(fees)" value="Update">
