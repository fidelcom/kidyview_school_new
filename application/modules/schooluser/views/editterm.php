					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									...
									<option ng-repeat="session in sessionList" ng-if="session.current_sesion == '1'" value="{{session.id}}">{{session.academicsession}}</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="date" class="form-control" ng-model="termstart">
								</div>
							</div>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="date" class="form-control" ng-model="termend">
								</div>
							</div>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<button class="btn btn-primary" ng-click="editTerm()" name="submit">Update</button>
