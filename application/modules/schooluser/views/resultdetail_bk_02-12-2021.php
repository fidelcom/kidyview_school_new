								...
								<div class="parent_box with_table mb-0 bg-light">
									...
									<table class="table table-striped table-bordered table-responsive text-left">
											...
											<tr  ng-repeat="termData in termListData" ng-if="(termData.term_id == term.term_id)">
												...
												<td>
													<span ng-if="(termData.obtain_exam_marks != '0')">
														{{ (termData.obtain_exam_marks ? termData.obtain_exam_marks+'/'+termData.total_exam_marks: '-') }}		
													</span>
													<span ng-if="(termData.obtain_exam_marks == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(termData.obtain_test_marks != '0')">
														{{ (termData.obtain_test_marks ? termData.obtain_test_marks+'/'+termData.total_test_marks: '-') }}		
													</span>
													<span ng-if="(termData.obtain_test_marks == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(termData.obtain_assignment_marks != '0')">
														{{ (termData.obtain_assignment_marks ? termData.obtain_assignment_marks+'/'+termData.total_assignment_marks: '-') }}		
													</span>
													<span ng-if="(termData.obtain_assignment_marks == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(termData.obtain_project_marks != '0')">
														{{ (termData.obtain_project_marks ? termData.obtain_project_marks+'/'+termData.total_project_marks: '-') }}		
													</span>
													<span ng-if="(termData.obtain_project_marks == '0')">
														{{ '-' }}		
													</span>
										...
										<tfoot class="bg-dark text-white">
											...
											<tr ng-repeat="termTotal in totalTermResult" ng-if="(termTotal.term_id == term.term_id)">
												<th class="text-center" colspan="4" style="color: red;background: white;">Result Status</th>
												<th class="text-center" colspan="4" style="color: blue;background: white;">	{{(termTotal.is_approved) ? termTotal.is_approved.toUpperCase() : '-'}}</th>
											</tr>

											<tr ng-repeat="termTotal in totalTermResult" ng-if="(termTotal.term_id == term.term_id) && (termTotal.is_approved == 'disapproved')">
												<th class="text-center" colspan="4" style="color: red;background: white;">Deny Reason</th>
												<th class="text-center" colspan="4" style="color: orange;background: white;">	{{(termTotal.reason) ? termTotal.reason.toUpperCase() : '-'}}</th>
											</tr>
										...
										<div class="row">
											<div class="col-md-12 text-left">
												<div class="form-group">
													<input type="radio" ng-model="resultStatus" name="resultStatus" value="approved"> Approved Result
												</div>
												<div class="form-group">
								...
								<div class="parent_box with_table mb-0 bg-light">
										...
										<tr ng-repeat="marks in totalGrandResult">
												...
												<td>
													<span ng-if="(marks.totalTermObtainExam != '0')">
														{{ (marks.totalTermObtainExam ? marks.totalTermObtainExam +'/'+ marks.totalTermExam: '-') }}
													</span>
													<span ng-if="(marks.totalTermObtainExam == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(marks.totalTermTestObtain != '0')">
														{{ (marks.totalTermTestObtain ? marks.totalTermTestObtain +'/'+ marks.totalTermTest: '-') }}
													</span>
													<span ng-if="(marks.totalTermTestObtain == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(marks.totalTermAssignObtain != '0')">
														{{ (marks.totalTermAssignObtain ? marks.totalTermAssignObtain +'/'+ marks.totalTermAssign: '-') }}
													</span>
													<span ng-if="(marks.totalTermAssignObtain == '0')">
														{{ '-' }}		
													</span>
												...
												<td>
													<span ng-if="(marks.totalTermProjObtain != '0')">
														{{ (marks.totalTermProjObtain ? marks.totalTermProjObtain +'/'+ marks.totalTermProj: '-') }}
													</span>
													<span ng-if="(marks.totalTermProjObtain == '0')">
														{{ '-' }}		
													</span>
									...
									<form class="mt-3" action=" ">
										<div class="row">
											<div class="col-md-12 text-left">
												<div class="form-group">
													<input type="radio" ng-model="resultStatus" name="allresultStatus" value="approved"> Approved Result
												</div>
												<div class="form-group">
