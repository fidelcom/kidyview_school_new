			...
			<div class="card-body">
				<form class="DriverDetails" name="myForm">
					<div class="divide-box row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select ng-model="drivervehicle" class="form-control" id="drivervehicle" >
                                                            ...
                                                            <option ng-repeat="vehicle in vehicleList" value="{{vehicle.id}}">{{vehicle.vehicle_name}} ({{vehicle.vcode}}) ({{vehicle.routepath}})</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
						...
						<div class="col-lg-6 col-md-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="col-md-12">
									...
									<img  ngf-src="driverphoto[0]" class="thumb">
								</div>
								</div>
								<div class="btn-uploadprof mt-0">
									<span>
										<i class="icon-camera-outline"></i>
										<input class="file-upload" ngf-select="" ngf-change="onChange($files)" id="pic" ng-model="driverphoto" accept="image/png, image/jpeg" type="file" />
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label class="form-label">Upload Documents <span class="dftcolor">(Insurance, Registration No., Pollution etc.)</span></label>
								<div class="col-md-12">
									<div class="upload-preview-box upload-img-view" ng-show="isImage(fileExt)">
									<img  ngf-src="driverdocument[0]" class="thumb">
								</div>
								</div>
								<div class="btn-uploadprof mt-0">
									<span>
										<i class="icon-camera-outline"></i>
										<!-- <input class="file-upload ng-pristine ng-valid ng-not-empty ng-touched" ngf-select="" ngf-change="onChange($files)" id="document"  ng-model="driverdocument" type="file"> -->
					...
					<div class="divide-box row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="form-group">
								...
								<div class="controls">
                                                                    <input type="password" style="width:100%;" ng-model="password" name="password" class="form-control " placeholder="Password">
								</div>
							</div>
						</div>	
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="password" style="width:100%;" ng-model="confirmPassword" name="confirmPassword"  class="form-control" placeholder="Confirm Password">
								</div>
							</div>
						</div>	
					...
					<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
						<div class="form-group">
							<button class="btn btn-primary" ng-disabled="myForm.$invalid" ng-click="addDriver()">Add Driver</button>
