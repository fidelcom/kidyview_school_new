			...
			<div class="card-body">
				<form name="myForm">
					<div class="row">
						...
						<!--<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<label class="form-label">Product ID<em>*</em></label>
								<div class="controls">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" class="form-control" ng-model="amount" allow-decimal-numbers>
								</div>
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<button class="btn btn-primary" ng-click="addGift()" name="submit">Submit</button>
