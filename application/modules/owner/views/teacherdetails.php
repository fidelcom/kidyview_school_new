				...
				<div class="row">
					<div class="col-md-3 col-sm-12 col-xs-12">
						<div class="profileimg">
							<img ng-show="teacherphoto != ''" class="img-fluid img-circle" src="<?=base_url();?>img/teacher/{{teacherphoto}}" alt="User profile" />
							<img ng-show="teacherphoto == ''" class="img-fluid img-circle" src="<?= base_url(); ?>img/article/noImage.png" />
						</div>
					</div>
