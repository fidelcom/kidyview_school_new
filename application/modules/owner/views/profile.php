						...
						<div class="row">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<div class="profileimg">
									...
									<img class="img-fluid img-circle profilePic" src="<?php echo base_url(); ?>img/admin/{{pic}}" alt="User profile" />
								</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="profileUserName" ng-model="name" class="form-control" />
									</div>
                                    <div class="form-group">
