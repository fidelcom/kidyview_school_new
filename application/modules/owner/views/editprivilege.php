						...
						<form>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<div class="controls">
										<select disabled class="form-control" ng-model="role">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="permission-container full-width">
										<div class="row heading">
											<div class="col-md-5 col-sm-5 col-12"><label class="form-label">Module</label></div>
											<div class="col-md-7 col-sm-7 col-12"><label class="form-label">Privileges</label></div>
										</div>
										<div class="row" ng-repeat="module in permissionRoleList">
											<div class="col-md-5 col-sm-5 col-12">
												<div class="form-check">
													<label class="form-check-label">{{module.module_name}}
														<input class="form-check-input" type="checkbox" ng-model="module.module_name" ng-click="checlAllPrivilege(module)" ng-true-value="module.module_name" ng-false-value="module.module_name" ng-checked="module.view==1 || module.add==1 || module.edit==1 || module.delete==1">
								...
								<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
									<div class="form-group">
									<button class="btn btn-primary" ng-click="editPrivilege()">Submit</button>
