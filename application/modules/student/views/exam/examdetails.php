...
<div class="row">
    ...
    <div class="col-md-6 text-left text-md-right" ng-if="examinfo.getUserExamAnswerData.length>0">
    <div class="col-md-12 text-left text-md-right" ng-show="examinfo.answerid!=null && (examinfo.exam_status!='Completed')">
        <a href="#!/exam-start/{{exID}}" class="btn btn-primary btn-sm">Start Exam</a>
    </div>
    <div ng-click="checkExamQuestion(examinfo);"  class="col-md-12 text-left text-md-right" ng-show="examinfo.answerid==null && (examinfo.exam_status=='Ongoing' || examinfo.exam_status=='Unlock')">
        <a href="#!/exam-start/{{exID}}" class="btn btn-primary btn-sm">Start Exam</a>
    </div>
    </div>
	<div class="col-md-6">
		<div class="text-danger notAdded" ng-if="examinfo.getUserExamAnswerData.length==0">
