       ...
       //echo $grade;die;
        ...
        if(!empty($examUserData)){
            $j=0;
                ...
                $notificationData['receiver_id'] = "T-".$getAssignedTeacher->id;
                $notificationData['sender_id'] = "ST-".$sid;
                $notificationData['to_do_id'] = $examUserData->id;
                $notificationData['message'] = $sudentname." submitted an exam.";
                $notificationData['type'] = "exam";
                $notificationData['url'] = "submitted-exam-details/".$encryptedUrl;
                $this->model->add($pnotificationData,'notifications');	
                }
                $userExamArray=array();
                $i=0;
