...
<form>
    <div class="question-block-e" ng-repeat="ques in examinfo.getUserExamAnswerData">
        <div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="button" ng-click="StopTimer();updateExam();" class="btn btn-primary">Submit</button>
...
<div class="modal-content">
    <div class="modal-body">
        <div class="del-comment-text text-center">
            <h6>Your exam time has been expire.Are you want to submit this exam?</h6>
        </div>
