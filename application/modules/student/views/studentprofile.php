			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-4 col-lg-3 col-sm-12 col-xs-12">
						...
						<div ng-show="studentData.childphoto != ''" class="del-prof-img profileImageHeader"><i class="icon-trash" ng-click="removeProfilePic(studentData)"></i></div>
							<img ng-show="studentData.childphoto != ''" class="img-fluid" src="<?=base_url();?>img/child/{{studentData.childphoto}}" alt="Student profile" />
							<img ng-show="studentData.childphoto == ''" class="img-fluid" src="<?= base_url(); ?>img/default-profilePic.png" />
						</div>
					...
					<div class="col-md-8 col-lg-9 col-sm-12 col-xs-12 mt-2 mt-md-0 ">
						<div class="card-body full-detail p-0">
							<ul>
								<li><span>Name:</span>{{studentData.childfname+' '+studentData.childmname+' '+studentData.childlname}}</li>
								<li><span>Class:</span>{{studentData.class}}</li>
								...
								<li><span>Address:</span> <span class="w-70">{{studentData.childaddress}}</span></li>
