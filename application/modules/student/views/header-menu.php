...
app.controller('headerControllers', function($scope,$http,$interval) {
	...
	$scope.getLatestNotification = function()
	{
		...
		$http.post(BASE_URL+'api/student/notification/getLatestNotification',formData,{
			headers:{
...
<!-- stard app header -->
<header class="app-header" ng-app = "KidyViewStudent" ng-controller="headerControllers">
