					...
					<tbody>
						<tr ng-repeat="assignment in studentAssignmentData">
							...
							<td class="action text-right">
								<a ng-show="assignment.isAssignmentOpen==1" href="#!/assignment-detail/{{assignment.assignmentID}}"><i class="icon-eye" title="View"></i></a>
								<a ng-show="assignment.isAssignmentOpen==0" title="Assignment Locked"><i class="fas fa-lock"></i></a>
							</td>
						</tr>															
					</tbody>
				</table>
