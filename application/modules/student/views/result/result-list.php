            ...
            <table datatable="ng" class="table result_class_filter table-striped table-bordered table-responsive">
                ...
                <tbody>
                    <tr ng-repeat="result in resultData">
                        ...
                        <td ng-repeat="term in result.termData"><span ng-if="term.id">{{term.obtain_term_marks+' / '+term.total_term_marks}}</span></td>
                        <td><span ng-if="result.overall_total_marks!=null">{{result.overall_marks_obtain}} / {{result.overall_total_marks}}</span></td>
                        <td class="action">
