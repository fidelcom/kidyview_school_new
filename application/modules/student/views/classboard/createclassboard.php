		...
		<div class="error" ng-show="errormsg">{{errormsg}}</div>
			<form>
						...
						<div class="form-group multi-dorpdown-list">
							<div class="controls">
								<select class="form-control" ng-model="class" ng-change="getStudentList();" >
									...
									<option value="{{class.id}}" ng-repeat="class in classData">{{class.classname}} ({{class.school_name}})</option>
								</select>
							</div>
						</div>
					</div>
				...
				<div class="row form-group mt-3">
					...
					<div class="col-md-6 pl-0">
						<button type="button" ng-click="createClassboard();" class="btn btn-primary">Create</button>
