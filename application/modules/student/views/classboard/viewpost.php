		...
		<div class="comment-container">
			...
			<div class="chat chat-left" ng-repeat="comment in post.commentData">
				<div class="chat-avatar">
					<a href="javascript:void(0);" class="avatar" ng-show="comment.user_type=='Student'"> 
					<img ng-show="comment.photo!=''" alt="" src="<?php echo base_url();?>img/child/{{comment.photo}}" class="img-fluid rounded-circle" width="40">
					<img ng-show="comment.photo==''" alt="" src="<?php echo base_url();?>img/noImage.png" class="img-fluid rounded-circle" width="40">
					</a>
					<a href="javascript:void(0);" class="avatar" ng-show="comment.user_type=='Teacher'"> 
					<img ng-show="comment.photo!=''" alt="" src="<?php echo base_url();?>img/teacher/{{comment.photo}}" class="img-fluid rounded-circle" width="40">
					<img ng-show="comment.photo==''" alt="" src="<?php echo base_url();?>img/noImage.png" class="img-fluid rounded-circle" width="40">
					</a>
				</div>
				<div class="chat-body">
