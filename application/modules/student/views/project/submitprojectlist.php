			...
			<div class="row">
				<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 align-self-center">
					...
					<div class="page-title">
						<h5>List Of Submitted Projects</h5>
					</div>
				</div>
			</div>
		</div>
				...
				<thead>
					...
					<tbody>
						<tr ng-repeat="assignment in studentSubmitAssignmentData">
							...
							<td><span ng-class="{'text-green':(assignment.project_status=='Graded' || assignment.project_status=='Marks Obtained')}">	{{assignment.project_status}}</span></td>
							<td class="action text-right">
								<a href="#!/submit-project-detail/{{assignment.assignmentID}}"><i class="icon-eye" title="View"></i></a>
								<a href="#!/edit-submit-project/{{assignment.assignmentID}}" ng-if="assignment.currdate<=assignment.submission_date && (assignment.no_of_attempt>1 || assignment.no_of_attempt=='')"><i class="icon-edit"></i></a>
								<a ng-if="assignment.currdate<=assignment.submission_date && (assignment.no_of_attempt>1 || assignment.no_of_attempt=='')" ng-click="deleteSubmitProject(assignment.asid,$index);"><i class="icon-trash2"></i></a>
							</td>
						</tr>															
					</tbody>
				</table>
