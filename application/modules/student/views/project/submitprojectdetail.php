...
<div class="page-icon">
<a href="#!/submit-project-list"> <i class="icon-arrow-back"></i></a>
</div>
...
<p class="days-left-con" ng-if="latedays!=''">late days : {{latedays}} </p>
	...
	<div class="row">
		<div class="col-md-3 col-lg-3 col-sm-12">Project Category:</div>
	...
	<div class="row" ng-if="assignmentinfo.getAssignMarkData.grade!=null && assignmentinfo.category=='graded'" >
