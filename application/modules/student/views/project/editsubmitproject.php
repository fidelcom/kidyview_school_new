					...
					<div class="card-body small-font">
						<form>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<div class="row">
										...
										<i class="icon-trash2" ng-click="removeAfterSelect($index);"></i>
										<div>{{prev.name}}</div>
										</div>
										</div>
										</div>
										<div class="col-md-12 prev-section mt-2" ng-repeat="attachData in attachmentArray">
										<div class="row">
										<div class="col-md-3 fpUploadImg">
											
											<div> {{attachData.name}} <i class="icon-trash2" ng-click="remove(attachData,$index);"></i></div>
										</div>
										</div>
										</div>
									</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 mt-3">
								<div class="form-group">
									<a class="btn btn-primary submit-btn" ng-click="editAttachment(ID);">Update</a>
									<a class="btn btn-secondary" href="#!/submit-project-list">Back To List</a>
								</div>
							</div>
							<div class="col-md-12">
