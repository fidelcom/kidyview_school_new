...
class Student extends MX_Controller {
    ...
    public function submitProject() {
        $this->load->view('project/submitproject');
    }
    public function submitProjectList() {
        $this->load->view('project/submitprojectlist');
    }
    public function submitprojectView() {
        $this->load->view('project/submitprojectdetail');
    }
    public function editsubmitproject() {
        $this->load->view('project/editsubmitproject');
    }
