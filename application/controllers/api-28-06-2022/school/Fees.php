<?php
	...
	public function feesList_post()
	{
		...
		$result = $this->Fees_model->feesList($postData['school_id'],$postData['session_id'],$postData['class_id']);
		// prd($result);
		if ($result) {
			$return['success'] = "true";
    ...
    public function transactionHistory_post()
	{
		...
		if ($postData == '') {
			$postData = $_POST;
                ...
                if(empty($classID) || empty($School_ID) || empty($session_ID)){
                $return['success'] = "false";
                $return['message'] = "something went wrong.";
                $return['error'] = $this->error;
                $return['data'] = $result;
		...
		$result = $this->Fees_model->paymentHistory($classID,$School_ID,$session_ID);
		if ($result) {
			$return['success'] = "true";
	...
	public function getClassStudentBySession_get() 
	{
		$school_id	=	$this->input->get('school_id');
		$session_id	=	$this->input->get('session_id');
		$class_id	=	$this->input->get('class_id');
		$result = $this->Fees_model->getClassStudentBySession($school_id,$session_id,$class_id);
		// prd($result);
