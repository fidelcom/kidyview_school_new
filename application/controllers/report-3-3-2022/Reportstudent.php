...
class Reportstudent extends REST_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('reports/Student_model', 'studentreport');
    }
    ...
    public function getAllSchool_post() {
        ...
        $result = $this->studentreport->getAllSchool($countryID);
    ...
    public function getAllSectionClass_post() {
        ...
        $result = $this->studentreport->getAllSectionClass($schoolid);
    ...
    public function getCountryList_post() {
        ...
        $result = $this->studentreport->getCountryList();
    ...
    public function getReport_post() {
        ...
        if (isset($postData['classSectionList']) && isset($postData['schoolLists']) && isset($postData['fromdate']) && isset($postData['todate'])) {
            ...
            $schoolParent = $this->studentreport->getStudentReport($searchingArray);
            if ($schoolParent) {
                $return['success'] = "true";
