...
class Reportdriver extends REST_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('reports/Driver_model', 'driverreport');
    }
    ...
    public function getAllSchool_post() {
        ...
        $result = $this->driverreport->getAllSchool($countryID);
    ...
    public function getAllSectionClass_post() {
        ...
        $result = $this->driverreport->getAllSectionClass($schoolid);
    ...
    public function getCountryList_post() {
        ...
        $result = $this->driverreport->getCountryList();
    ...
    public function getReport_post() {
        ...
        if (isset($postData['classSectionList']) && isset($postData['schoolLists']) && isset($postData['fromdate']) && isset($postData['todate'])) {
            ...
            $schoolParent = $this->driverreport->getSchoolDriver($searchingArray);
            if ($schoolParent) {
                $return['success'] = "true";
