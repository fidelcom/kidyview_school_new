        ...
        if(!empty($examUserData)){
            $j=0;
                ...
                if($examUserData->exam_mode=='exam'){
                    $notificationData[0]['message'] = $sudentname." has submitted his/her exam successfully";
                }elseif($examUserData->exam_mode=='test'){
                    $notificationData[0]['message'] = $sudentname." has submitted his/her test successfully";
                }
                ...
                $sendData['tname']=$getAssignedTeacher->teachername;
					...
					$sendData['atype']= $examUserData->exam_mode;
                    $m= 'Child submitted '.$examUserData->exam_mode;
					$message = $this->load->view('emailtemplate/childSubmittedAssismentTemplate',$sendData, true);
                    sendKidyviewEmail($getAssignedTeacher->teacheremail,'','','', $m, $message);
                }
                $userExamArray=array();
                $i=0;
               ...
               $addAnswer=$this->model->add($userExamArray,$tbl_name2);
                    ...
                    $termData =get_session_n_terms($examUserData->school_id,$examUserData->exam_date);
                    ...
                    $marksArray[$j]['term_name']=$termData->termname;
                    $marksArray[$j]['term_id']=$termData->term_id;
                    $marksArray[$j]['session_id']=$termData->session_id;
               ...
               if(isset($addAnswer)){
                ...
                $user_id="S-".$schoolID;
                $isNotify=notificationSettingHelper($schoolID,$user_id,'Exam');
                $schoolNotificationData['receiver_id'] = $user_id;
                $schoolNotificationData['sender_id'] = "ST-".$sid;
                $schoolNotificationData['to_do_id'] = $examUserData->id;
                if($examUserData->exam_mode=='exam'){
                    $schoolNotificationData['message'] = $sudentname." has submitted his/her exam successfully";
                }elseif($examUserData->exam_mode=='test'){
                    $schoolNotificationData['message'] = $sudentname." submitted an has submitted his/her test successfully";
                }
                $schoolNotificationData['school_id'] = $schoolID;
                $schoolNotificationData['type'] = "exam";
                $schoolNotificationData['url'] = "view-submit-exam/".$encryptedUrl;
                ...
                $schoolEmail='';
                $schoolData=getSchoolDetails($schoolID);
                if(!empty($schoolData)){
                ...
                sendKidyviewEmail($schoolEmail,'','','',$m, $message);
                }
                $return['success'] = "true";
                $return['title'] = "success";
                $return['message'] = "Exam Submit successfully.";
        ...
        if(!empty($postData)){
            ...
            foreach($postData as $examData){
               ...
               if($updateAnswer){
                ...
                $schoolNotificationData['receiver_id'] = $user_id;
                $schoolNotificationData['sender_id'] = "ST-".$sid;
                $schoolNotificationData['to_do_id'] = $examData['id'];
                if($examData['exam_mode']=='exam'){
                    $schoolNotificationData['message'] = $sudentname." submitted an exam.";
                }elseif($examData['exam_mode']=='test'){
                    $schoolNotificationData['message'] = $sudentname." submitted an test.";
                }
                $schoolNotificationData['school_id'] = $schoolID;
                $schoolNotificationData['type'] = "exam";
                $schoolNotificationData['url'] = "view-submit-exam/".$encryptedUrl;
                ...
                $message = $this->load->view('emailtemplate/commonTemplate',$schoolNotificationData, true);
                //$this->sendMail($schoolEmail, "New Submitted Project", $message);
                sendKidyviewEmail($schoolEmail,'','','','New Submitted Exam', $message);
                }
                $return['success'] = "true";
                $return['title'] = "success";
                $return['message'] = "Exam Submit successfully.";
