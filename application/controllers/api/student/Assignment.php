	...
	class Assignment extends REST_Controller {
		...
		public function submitAssignment_post() {
			...
			//}	
				...
				$pnotificationData['message'] = $sudentname." has submitted his/her assignment successfully";
				...
				if($getAssignedTeacher){
					...
					$sendData['atype']='assignment';
					$message = $this->load->view('emailtemplate/childSubmittedAssismentTemplate',$sendData, true);
                    sendKidyviewEmail($getAssignedTeacher->teacheremail,'','','', 'Child submitted assignment', $message);
				}
			...
			$schoolNotificationData['message'] = $sudentname." has submitted his/her assignment successfully.";
			...
			sendKidyviewEmail($schoolEmail,'','','','CHils submitted Assignment', $message);
			}
				$return['success'] = "true";
