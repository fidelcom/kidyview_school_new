...
class Result extends REST_Controller {
    ...
    public function calculateStudentsResult_post() {  	
     ...
     if ($postData == '') {
      ...
      $result = $this->model->calculateStudentsResult($school_id);
// prd($result);
        	if($result) {
    ...
    public function getStudentExamDetails_post()
    {
      ...
      $result = $this->model->getStudentExamDetails($student_id,$school_id);
// prd($result);
          if($result) {
    ...
    public function calculateSubjectTermResult_post()
    {
      ...
      $result = $this->model->calculateSubjectTermResult($student_id,$school_id);
// prd($result);
          if($result) {
    ...
    public function getSubjectGrandsResult_post()
    {
      ...
      $result = $this->model->getSubjectGrandsResult($student_id,$school_id);
// prd($result);
          if($result) {
