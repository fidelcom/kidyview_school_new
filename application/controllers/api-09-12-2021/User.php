...
// lq();
		...
		public function addChild_post() {
			...
			$school_subscription_data=get_school_subscription_data($postData['schoolId']);
			if($countStudent>=$school_subscription_data['no_of_student']){
				$return['success'] = "false";
				$return['message'] = "You have exceed student add limit.";
				$return['error'] = $this->error;
				$return['data'] = $this->data;
				$this->response($return, REST_Controller::HTTP_BAD_REQUEST);
			}
