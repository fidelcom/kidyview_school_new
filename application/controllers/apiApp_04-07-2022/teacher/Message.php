...
class Message extends REST_Controller {
    ...
    function test_get(){
        $pass = "KidyView";
		$text = 1;
        echo $enctUrl= encryptData($text,$pass);
    }
    public function list_get(){
        $user = "T-".$this->token->user_id;
    ...
    public function index_post() {        
        ...
        foreach ($recievers as $reciever)
        {
            ...
            {   
                ...
                $formData['sender'] = "T-".$this->token->user_id;
			...
			sendMail($schoolEmail, "New Graded Assignment", $message);
			}*/
    ...
    public function index_delete($id){
        $user = "T-".$this->token->user_id;
        $res = $this->message_model->deleteConversationMessage($user,$id);
