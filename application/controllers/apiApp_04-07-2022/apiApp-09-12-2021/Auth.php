...
class Auth extends REST_Controller {
    ...
    public function signin_post() {
        ...
        if ((isset($postData['email']) || isset($postData['phnno'])) && (isset($postData['fcm_key']))) {
            ...
            if ($result) {
                ...
                $this->response(["status" => "error", "message" => "Email ID  / Mobile number  Does not exist"], REST_Controller::HTTP_BAD_REQUEST);
            }
        } else {
            $this->response(["status" => "error", "message" => "Please fill all field."], REST_Controller::HTTP_BAD_REQUEST);
        }
    ...
    public function verifyotp_post() {
        ...
        if($otp == '12345' && isset($otpData->teacheremail) && $otpData->teacheremail=='kabirsharma759@gmail.com')
        $result = $otpData;
        else
