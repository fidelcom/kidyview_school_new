...
class Driverdata extends REST_Controller {
    ...
    public function driverStudents_post() {
        ...
        $journey_session = isset($postData['journey_session']) ? $postData['journey_session'] : "";
     ...
     public function sendNotification($student_id,$driverID,$session)
     {
         if((!empty($student_id)) &&  (!empty($driverID)) && $session!="")
         {
             ...
             {   
                 ...
                 if($session=='drop')
                 $messageData = 'Your Child '.$childName.' Dropped Successfully'; 
