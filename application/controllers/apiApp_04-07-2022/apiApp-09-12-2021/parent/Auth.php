...
class Auth extends REST_Controller {
    ...
    public function verifyotp_post() {
        ...
        if($otp == '12345' && isset($otpData->fatheremail) && isset($otpData->motheremail)  && ($otpData->fatheremail=='kabirsharma759@gmail.com' || $otpData->motheremail=='kabirsharma759@gmail.com'))
        $result = $otpData;
        else
