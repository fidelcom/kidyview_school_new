...
class Parentapp extends REST_Controller {
    ...
    public function getThoughtOfTheDay_get($school_id = '', $parent_id = '') {
        $albumData=array();
        $albumData = $this->model->getThoughtOfTheDay($school_id, $parent_id = '');
        $schoolData = $this->model->getSchool($school_id);
