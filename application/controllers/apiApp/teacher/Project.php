        ...
        if ($dataid) {
			...
			if (!empty($getClassStudentData)) {
				foreach ($getClassStudentData as $studentData)
				{
					...
					$isNotify=notificationSettingHelper($this->token->school_id,$student_id,'Project');
					...
					//$isParentNotify=notificationSettingHelper($this->token->school_id,$pnotificationData['receiver_id'],'Project');
                    ...
                    //sendMail($studentEmail, "Your New Project", $message);
                    ...
                    //sendMail($parentEmail, "Your Child New Project", $message);
			...
			$isNotify=notificationSettingHelper($this->token->school_id,$user_id,'Project');
			$schoolNotificationData['receiver_id'] = $user_id;
			$schoolNotificationData['sender_id'] = "T-".$this->token->user_id;
			$schoolNotificationData['to_do_id'] = $dataid;
			$schoolNotificationData['school_id'] = $this->token->school_id;
            ...
            //sendMail($schoolEmail, "New Project", $message);
