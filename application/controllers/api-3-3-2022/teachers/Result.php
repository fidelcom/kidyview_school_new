<?php
	...
	class Result extends REST_Controller {
		...
		public function __construct() {
			...
			$this->load->model(array('teachers/Results_model'));
	...
	public function getResultList_post() {
		...
		$result = $this->Results_model->getResultList($schoolID,$id,$filterbydate='',$class_id,$subject_id='',$category='');
	...
	public function getStudentExamDetails_post()
    {
      ...
      $result = $this->Results_model->getStudentExamDetails($student_id,$school_id);
// prd($result);
          if($result) {
    ...
    public function calculateSubjectTermResult_post()
    {
      ...
      $result = $this->Results_model->calculateSubjectTermResult($student_id,$school_id);
// prd($result);
          if($result) {
    ...
    public function getSubjectGrandsResult_post()
    {
      ...
      $result = $this->Results_model->getSubjectGrandsResult($student_id,$school_id);
          if($result) {
