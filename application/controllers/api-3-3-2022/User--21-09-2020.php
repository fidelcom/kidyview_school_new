<?php
	...
	class User extends REST_Controller {
		...
		public function getSubadminProfile_get() {
			$result = $this->User_model->getSubadminProfileDetails();
			if ($result) {
				$return['success'] = "true";
		...
		public function getStudentUsernamePassword_post() {
			...
			if ($result) {
				...
				$mailResponse = $this->sendMailForCC($to,$bcc,'',  "Your child login details for kidyview", $message);
			}
