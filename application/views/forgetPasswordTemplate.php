    ...
    <table cellpadding="0" cellspacing="0" style="max-width:600px; margin:0% auto; padding:0px; text-align:center; font-family:Verdana, Geneva, Tahoma, sans-serif;">
        <tr>
            <td>
                ...
                <a href="<?=base_url()?>api/verify/forgetPassword/<?=$encryptedCode?>" style="background:#00596f; padding:10px 50px; display:inline-block; color:#fff; font-weight:bold; font-family:Verdana, Geneva, Tahoma, sans-serif; text-decoration:none; border-radius:8px;">Click here to verify your email address</a>
            </td>
        </tr>
    </table>
