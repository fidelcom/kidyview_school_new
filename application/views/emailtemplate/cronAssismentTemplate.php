	...
	<body style="background: #fafafa;">
		<div Style="max-width:650px; margin:0 auto;font-family:Arial, Helvetica, sans-serif;line-height: 25px;background: #fff;">
			...
			<div style="padding:10px 0px;margin-bottom: 10px;padding:20px 30px;">
				<h2 style="margin: 0;padding: 0;color: #006e7c;margin-bottom: 30px;font-size:30px;">Dear <?php echo ucfirst($pname);?>,</h2>
				<h3 style="margin: 0 0 30px 0;padding: 0;color: #000;font-weight: 400;font-size:22px;line-height: 30px;"><?php echo $message;?></h3>	
				<p>Please ensure your child submit before the due time.</p>
