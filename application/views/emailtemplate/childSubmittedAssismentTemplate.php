	...
	<body style="background: #fafafa;">
		<div Style="max-width:650px; margin:0 auto;font-family:Arial, Helvetica, sans-serif;line-height: 25px;background: #fff;">
			...
			<div style="padding:10px 0px;margin-bottom: 10px;padding:20px 30px;">
				<h2 style="margin: 0;padding: 0;color: #006e7c;margin-bottom: 30px;font-size:30px;">Dear <?php echo ucwords($tname);?>,</h2>				
				<p><?php echo ucwords($sname);?> has submitted his/her <?php echo $atype;?>, successfully. </p>
				<p>Kindly login on kidyview to view the <?php echo $atype;?>.</p>
