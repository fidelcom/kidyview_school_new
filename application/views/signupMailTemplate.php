...
<head>
    <meta charset="utf-8" />
    <title>KidyView School : Signup</title>
</head>
<body>
    ...
    <table cellpadding="0" cellspacing="0" style="max-width:600px; margin:0% auto; padding:0px; text-align:center; font-family:Verdana, Geneva, Tahoma, sans-serif;">
        <tr>
            <td>
                <img src="<?= base_url()?>img/small_logo.png" alt="KidyView" style="max-width:200px; margin:0 auto; height:auto;" />
                ...
                <a href="<?=base_url()?>api/verify/signup/<?=$encryptedCode?>" style="background:#00596f; padding:10px 50px; display:inline-block; color:#fff; font-weight:bold; font-family:Verdana, Geneva, Tahoma, sans-serif; text-decoration:none; border-radius:8px;">Click here to verify your email address</a>
            </td>
        </tr>
    </table>
