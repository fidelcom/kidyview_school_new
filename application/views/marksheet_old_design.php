              ...
              <table class="marks" style="width:100%;background:#f00;">
                  ...
                  <tr>
                      ...
                      <td align="left" valign="top" style="width:25%; border-left:none;"><h4> Subject </h4></td>
                       ...
                       <td align="left" valign="top" style="width:8%;"><h4> Total Mark </h4></td>
                       <td align="left" valign="top" style="width:8%;"><h4> Obtained Mark </h4></td>
                 ...
                 <?php 
                  ...
                  echo '<tr><td align="left" valign="top" colspan="8" style="border:none;"><h3>Final Term</h3></td></tr>';  
                  echo '<tr>';
                  ...
                  echo '<td align="left" valign="top" style="width:8%;"><h4> Total Mark </h4></td>';
                  echo '<td align="left" valign="top" style="width:8%;"><h4> Obtained Mark </h4></td>';
                  ...
                  echo '<td align="left" valign="top">'.($finalDataArr[$j]['totalTermObtainExam']!='0' ?  $finalDataArr[$j]['totalTermObtainExam']."/".$finalDataArr[$j]['totalTermExam'] : '-').'</td>';
                  echo '<td align="left" valign="top">'.($finalDataArr[$j]['totalTermTestObtain']!='0' ?  $finalDataArr[$j]['totalTermTestObtain']."/".$finalDataArr[$j]['totalTermTest'] : '-').'</td>';
                  echo '<td align="left" valign="top">'.($finalDataArr[$j]['totalTermAssignObtain']!='0' ?  $finalDataArr[$j]['totalTermAssignObtain']."/".$finalDataArr[$j]['totalTermAssign'] : '-').'</td>';
                  echo '<td align="left" valign="top">'.($finalDataArr[$j]['totalTermProjObtain']!='0' ?  $finalDataArr[$j]['totalTermProjObtain']."/".$finalDataArr[$j]['totalTermProj'] : '-').'</td>';
