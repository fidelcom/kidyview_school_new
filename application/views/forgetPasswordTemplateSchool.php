...
<head>
    <meta charset="utf-8" />
    <title>Kidy View : Forgot Password</title>
</head>
<body>
    ...
    <table cellpadding="0" cellspacing="0" style="max-width:600px; margin:0% auto; padding:0px; text-align:center; font-family:Verdana, Geneva, Tahoma, sans-serif;">
        <tr>
            <td>
                ...
                <a href="<?=base_url()?>api/verify/forgetPasswordSchool/<?=$encryptedCode?>" style="background:#00596f; padding:10px 50px; display:inline-block; color:#fff; font-weight:bold; font-family:Verdana, Geneva, Tahoma, sans-serif; text-decoration:none; border-radius:8px;">Click here to update your password</a>
            </td>
        </tr>
    </table>
