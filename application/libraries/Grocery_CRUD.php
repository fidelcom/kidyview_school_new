		...
		switch ($real_type) {
			...
			case 'upload_file':
				...
				else
				{
					...
					$file_url_anchor = '<a data-fancybox="images"  href="'.$file_url.'"';
					if($is_image)
					{
	...
	protected function get_text_input($field_info,$value)
	{
		if($field_info->extras == 'text_editor')
		{
			...
			$input = "<textarea id='field-{$field_info->name}' name='{$field_info->name}' class='$class_name' >$value</textarea>";
                        //$input = "<textarea id='field-{$field_info->name}' name='{$field_info->name}' class='$class_name my_ckeditor' >$value</textarea>";
                        /*$input .= "<script>CKEDITOR.replace( 'field-{$field_info->name}', {
                                    filebrowserBrowseUrl: '".base_url()."{$this->default_texteditor_path}/ckeditor/plugins/imageuploader/imgbrowser.php',
                                    filebrowserImageBrowseUrl: '".base_url()."{$this->default_texteditor_path}/ckeditor/plugins/imageuploader/imgbrowser.php?type=Images',
                                    filebrowserUploadUrl: '".base_url()."{$this->default_texteditor_path}/ckeditor/plugins/imageuploader/imgupload.php',
                                    filebrowserImageUploadUrl: '".base_url()."{$this->default_texteditor_path}/ckeditor/plugins/imageuploader/imgupload.php?type=Images',
                                    width:700    
                                });</script>";*/
