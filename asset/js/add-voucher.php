                    ...
                    <div class="card">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" class="form-control" ng-model="voucherObj.quantity" id="quantity" name="voucherObj.quantity">
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" class="form-control" name="points" id="points" ng-model="voucherObj.points">
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" class="form-control" name="product_id" id="product_id" ng-model="voucherObj.product_id">
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group col-md-12">
							<button class="btn btn-primary" ng-click="addVoucher();">Add</button>
						</div>
					</div>
                            </form>
                        </div>
