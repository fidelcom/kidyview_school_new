...
!(function(a, b) {
    ...
    !(function(b) {
        ...
        return {
          ...
          link: function(b, c, d, e) {
            ...
            function h(c) {
              ...
              c ? (d = f(c)) : a.isUndefined(b.fallbackValue) && (d = c),
                e.$setViewValue(d),
                g(d);
            }
            var i = c.find('input'),
            ...
            a.forEach(
              ...
              a.isFunction(b.onBeforeShow) &&
                (m.beforeShow = function(a) {
                  return b.onBeforeShow({ color: f(a) });
                }),
              b.palette && (m.palette = b.palette);
            var n = a.extend({}, l, b.options, m);
            b.triggerId &&
              a.element(document.body).on('click', '#' + b.triggerId, k),
              (e.$render = function() {
                i.spectrum('set', e.$viewValue || ''), g(e.$viewValue);
              }),
              n.color && (i.spectrum('set', n.color || ''), h(n.color)),
              i.spectrum(n),
              b.$on('$destroy', function() {
                b.triggerId &&
                  a.element(document.body).off('click', '#' + b.triggerId, k);
              }),
              c.on('$destroy', function() {
                i.spectrum('destroy');
              }),
              a.isDefined(n.disabled) && (b.disabled = !!n.disabled),
              b.$watch('disabled', function(a) {
      ...
      a.module('angularSpectrumColorpicker').run([
        '$templateCache',
        function(a) {
